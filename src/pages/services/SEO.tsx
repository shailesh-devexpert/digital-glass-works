  ...
  const features = [
    {
      ...
      description: 'In-depth keyword analysis to target the right search terms.',
    },
    {
      icon: TrendingUp,
      title: 'On-Page SEO',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              Our SEO <span className="gradient-text">Approach</span>
            </h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8 reveal">
            <h2 className="text-3xl md:text-5xl font-bold">
              Ready to Improve Your <span className="gradient-text">Rankings</span>?
            </h2>
            <p className="text-xl text-muted-foreground">
              Let's optimize your website and drive more organic traffic to your business.
            </p>
            <Button size="xl" variant="hero" asChild>
              <Link to="/contact">
                Start SEO Campaign <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </div>
        </div>
